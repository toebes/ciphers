...
config = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            cipher: 'TestManage',
            title: '2021-2022 Season Science Olympiad Rules Summary',
        }),
        new HtmlWebpackPlugin({
            inject: false,
            filename: 'Rule-Summary-2023.html',
            template: path.join(__dirname, 'app', 'codebusters', 'pages', 'Rule-Summary-2023.html'),
            cipher: 'TestManage',
            title: '2022-2023 Season Science Olympiad Rules Summary',
        }),
        new HtmlWebpackPlugin({
            inject: false,
        ...
        new HtmlWebpackPlugin({
            inject: false,
            filename: 'Rule-Summary-2025.html',
            template: path.join(__dirname, 'app', 'codebusters', 'pages', 'Rule-Summary-2025.html'),
            cipher: 'TestManage',
            title: '2024-2025 Season Science Olympiad Rules Summary',
        }),
        new HtmlWebpackPlugin({
            inject: false,
        ...
        new HtmlWebpackPlugin({
            inject: false,
            filename: 'Rule-Summary-2027.html',
            template: path.join(__dirname, 'app', 'codebusters', 'pages', 'Rule-Summary-2027.html'),
            cipher: 'TestManage',
            title: '2026-2027 Season Science Olympiad Rules Summary',
        }),
        new HtmlWebpackPlugin({
            inject: false,
        ...
        new HtmlWebpackPlugin({
            inject: false,
            filename: 'HomophonicEncrypt.html',
            template: path.join(__dirname, 'app', 'codebusters', 'pages', 'StdEncoder.html'),
            cipher: 'Homophonic',
            title: 'Homophonic Encoder',
        }),
        new HtmlWebpackPlugin({
            inject: false,
