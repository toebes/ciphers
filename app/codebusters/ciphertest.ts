...
import { DifficultyType, TemplateTestTypes, TestDifficultyType, ITempleteInfo } from './ciphertestbuild';
...
export class CipherTest extends CipherEncoder {
    ...
    public allowableNewCiphers: INewCipherEntry[] = [
    ...
    public genNewCipherDropdown(
        ...
        for (const entry of this.allowableNewCiphers) {
