...
/**
 * CipherStandardGalacticAlphabetEncoder - This class handles all of the actions associated with encoding
 * a StandardGalacticAlphabet cipher.
 */
export class CipherStandardGalacticAlphabetEncoder extends CipherEncoder {
    public activeToolMode: toolMode = toolMode.codebusters;
    public guidanceURL = 'TestGuidance.html#StandardGalacticAlphabet';
    public usesStandardGalacticAlphabetTable = true;
    public cipherName = 'Standard Galactic Alphabet';
    ...
    public genAnswer(testType: ITestType): JQuery<HTMLElement> {
        ...
        const table = new JTTable({
            class: 'ansblock shrink cell unstriped sga' + extraclass,
        });
        const tosolve = 0;
        const toanswer = 1;
    ...
    public genSolution(testType: ITestType): JQuery<HTMLElement> {
        ...
        result.append(
            $('<p/>').text(
                'First you want to find the table of the Standard Galactic Alphabet characters in the resources for the test. ' +
                'It should look like:'
            )
        );
        result.append(
