...
var CipherMorseSolver = /** @class */ (function (_super) {
     ...
     */
    CipherMorseSolver.prototype.build = function (str) {
        ...
        for (i = 0, len = str.length; i < len; i++) {
            ...
            if (this.isValidChar(c)) {
                ...
                var morsepiece = this.getMorseMap()[c] + '????';
     ...
     */
    CipherMorseSolver.prototype.createFreqEditTable = function () {
     ...
     */
    CipherMorseSolver.prototype.setMultiChars = function (reqstr) {
     ...
     *
     * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    CipherMorseSolver.prototype.findPossible = function (str) {
    ...
    CipherMorseSolver.prototype.normalizeHTML = function (str) {
        return str.replace(/O/g, '&#9679;').replace(/-/g, "&ndash;").replace(/X/g, "&times;");
    };
    CipherMorseSolver.prototype.load = function () {
