 ...
 */
    ...
    */
    ...
    CipherHandler.prototype.updateCheck = function (c, lock) {
     ...
     */
    CipherHandler.prototype.isort = function (a, b) {
        if (a.freq > b.freq) {
            return -1;
        }
     ...
     * @param {number} num
     */
    CipherHandler.prototype.makeTopList = function (str, width, num) {
        var tfreq = {};
        var tobjs = [];
        var work = '';
        var i, len;
    ...
    CipherHandler.prototype.iscoprime = function (a) {
        var charset = this.getCharset();
