...
const cipherTypeConfig = new Map(<[ICipherType, any][]>[
    [
        ICipherType.None,
        {
            title: 'None',
    ...
    [ICipherType.Affine, { title: 'Affine', id: 'affine', equiv: [ICipherType.Affine] }],
    [
        ICipherType.Amsco,
        /* Not Yet Implemented */ {
            title: 'Amsco',
    ...
    [
        ICipherType.Aristocrat,
        {
            title: 'Aristocrat',
            id: 'aristocrat',
            equiv: [ICipherType.Aristocrat, ICipherType.Patristocrat, ICipherType.Xenocrypt],
        },
    ],
    [
        ICipherType.Atbash,
    ...
    [ICipherType.Baconian, { title: 'Baconian', id: 'baconian', equiv: [ICipherType.Baconian] }],
    [
    ...
    [ICipherType.Counter, { title: 'Counter', id: 'counter', equiv: [ICipherType.Counter] }],
    [
    ...
    [ICipherType.Gromark, { title: 'Gromark', id: 'gromark', equiv: [ICipherType.Gromark] }],
    [
        ICipherType.Gronsfeld,
        {
            title: 'Gronsfeld',
    ...
    [ICipherType.Hill, { title: 'Hill', id: 'hill', equiv: [ICipherType.Hill] }],
    [
    ...
    [ICipherType.Morbit, { title: 'Morbit', id: 'morbit', equiv: [ICipherType.Morbit] }],
    [
    ...
    [ICipherType.Ragbaby, { title: 'Ragbaby', id: 'ragbaby', equiv: [ICipherType.Ragbaby] }],
    [
...
export function getCipherTitle(ciphertype: ICipherType): string {
    const config = cipherTypeConfig.get(ciphertype);
    let title = 'NOT_FOUND';
